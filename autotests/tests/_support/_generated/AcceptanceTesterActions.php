<?php  //[STAMP] 1331ba1144e4dab5add3a7505a5bb1dd
...
trait AcceptanceTesterActions
{
    ...
    public function configGet() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('configGet', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::getDataFromMemcache()
     */
    public function getDataFromMemcache($key) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDataFromMemcache', func_get_args()));
    }
    ...
    public function configSet($newData) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('configSet', func_get_args()));
    }
    ...
    public function formatNumber($number) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('formatNumber', func_get_args()));
    }
    ...
    public function unzip($srcFile, $destDir = null, $createZipNameDir = null, $overwrite = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('unzip', func_get_args()));
    }
    ...
    public function csvToArray($csvFile) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('csvToArray', func_get_args()));
    }
    ...
    public function parseIdFromNotification($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('parseIdFromNotification', func_get_args()));
    }
    ...
    public function validateDate($date, $format = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('validateDate', func_get_args()));
    }
    ...
    public function grabDateFromString($string) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabDateFromString', func_get_args()));
    }
    ...
    public function calcPrice($period, $rate = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('calcPrice', func_get_args()));
    }
}
