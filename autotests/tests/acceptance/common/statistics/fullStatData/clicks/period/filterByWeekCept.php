...
$I->wantTo('Check issue clicks period filter by week stat');
...
$custom->checkDataInFirstTableLine('table', ['20.04.2015', '1 273', '717']);
$I->see('0.26%', 'table tbody tr:nth-child(1) td:nth-child(2) div');
$I->see('0.15%', 'table tbody tr:nth-child(1) td:nth-child(3) div');
