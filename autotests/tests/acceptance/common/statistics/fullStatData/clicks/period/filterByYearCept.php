...
$I->wantTo('Check issue clicks period filter by year stat');
...
$custom->checkDataInFirstTableLine('table', ['2015', '1 623', '859']);
$I->see('0.33%', 'table tbody tr:nth-child(1) td:nth-child(2) div');
$I->see('0.18%', 'table tbody tr:nth-child(1) td:nth-child(3) div');
