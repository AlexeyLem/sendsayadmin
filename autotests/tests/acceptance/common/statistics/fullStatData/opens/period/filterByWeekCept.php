...
$I->wantTo('Check issue opens period filter by week stat');
...
$custom->checkDataInFirstTableLine('table', ['20.04.2015', '19 692', '8 989']);
$I->see('4.02%', 'table tbody tr:nth-child(1) td:nth-child(2) div');
$I->see('1.84%', 'table tbody tr:nth-child(1) td:nth-child(3) div');
